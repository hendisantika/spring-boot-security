...
public class UserDataLoader implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		admin.setFirstName("Hendi");
		admin.setLastName("Santika");
		...
		adminAddr1.setAddrCity("Konohagakure");
		adminAddr1.setAddrState("KNH");
		adminAddr1.setZipCode("911");
		...
		adminAddr2.setAddrCity("Sunagakure");
		adminAddr2.setAddrState("CAI");
		...
		User user1 = new User();
		user1.setUsername("madara");
		user1.setPassword("123456");
		user1.setFirstName("Uchiha");
		user1.setLastName("Madara");
